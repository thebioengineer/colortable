...
Not only is hardcoding a bad practice, but then the outputs are not flexible.
...
![html_table_example](inst/media/html_table_example.PNG)

There are many more use-cases and code surrounding this package, but I feel like this would be the most common use-case. 

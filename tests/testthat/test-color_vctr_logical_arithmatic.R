...
input_vect <- c(TRUE, TRUE, FALSE, TRUE, FALSE, TRUE)
...
test_that("subtraction works with numeric and preserves styling", {
  ...
  expect_equal( field(subtraction_c_vect_1,  "vctr"), 1-input_vect   )
  expect_equal( field(subtraction_c_vect_2,  "vctr"), 2-input_vect )
  expect_equal( field(subtraction_c_vect_neg,"vctr"), -1-input_vect  )
  expect_equal( field(subtraction_1_c_vect,  "vctr"), input_vect-1   )
  expect_equal( field(subtraction_2_c_vect,  "vctr"), input_vect-2 )
  expect_equal( field(subtraction_neg_c_vect,"vctr"), input_vect--1  )
...
test_that("addition works with numeric and preserves styling", {
  ...
  expect_equal( field(add_c_vect_1,  "vctr"), 1+input_vect   )
  expect_equal( field(add_c_vect_2,  "vctr"), 2+input_vect )
  expect_equal( field(add_c_vect_neg,"vctr"), -1+input_vect  )
  expect_equal( field(add_1_c_vect,  "vctr"), input_vect+1   )
  expect_equal( field(add_2_c_vect,  "vctr"), input_vect+2 )
  expect_equal( field(add_neg_c_vect,"vctr"), input_vect+-1  )
...
test_that("division works with numeric and preserves styling", {
  ...
  expect_equal( field(div_c_vect_1,  "vctr"), 1/input_vect )
  expect_equal( field(div_c_vect_2,  "vctr"), 2/input_vect )
  expect_equal( field(div_c_vect_neg,"vctr"), -1/input_vect )
  expect_equal( field(div_1_c_vect,  "vctr"), input_vect/1 )
  expect_equal( field(div_2_c_vect,  "vctr"), input_vect/2 )
  expect_equal( field(div_neg_c_vect,"vctr"), input_vect/-1  )
...
test_that("multiplication works with numeric and preserves styling", {
  ...
  expect_equal( field(mult_c_vect_1,  "vctr"), 1*input_vect   )
  expect_equal( field(mult_c_vect_2,  "vctr"), input_vect*2 )
  expect_equal( field(mult_c_vect_neg,"vctr"), -input_vect  )
  expect_equal( field(mult_1_c_vect,  "vctr"), input_vect*1   )
  expect_equal( field(mult_2_c_vect,  "vctr"), input_vect*2 )
  expect_equal( field(mult_neg_c_vect,"vctr"), -input_vect  )
...
test_that("exponents work with numeric and preserves styling", {
  ...
  expect_equal( field(exp_c_vect_1,  "vctr"), 1^input_vect   )
  expect_equal( field(exp_c_vect_2,  "vctr"), 2^input_vect )
  expect_equal( field(exp_c_vect_neg,"vctr"), -1^input_vect  )
  expect_equal( field(exp_1_c_vect,  "vctr"), input_vect^1)
  expect_equal( field(exp_2_c_vect,  "vctr"), input_vect^2 )
  expect_equal( field(exp_neg_c_vect,"vctr"), input_vect^-1  )
...
test_that("modulo work with numeric and preserves styling", {
  ...
  expect_equal( field(modulo_c_vect_1,  "vctr"), 1%%input_vect   )
  expect_equal( field(modulo_c_vect_2,  "vctr"), 2%%input_vect )
  expect_equal( field(modulo_c_vect_neg,"vctr"), -1%%input_vect  )
  expect_equal( field(modulo_1_c_vect,  "vctr"), input_vect%%1   )
  expect_equal( field(modulo_2_c_vect,  "vctr"), input_vect%%2 )
  expect_equal( field(modulo_neg_c_vect,"vctr"), input_vect%%-1  )
...
test_that("integer division work with numeric and preserves styling", {
  ...
  expect_equal( field(int_div_c_vect_1,  "vctr"), 1%/%input_vect   )
  expect_equal( field(int_div_c_vect_2,  "vctr"), 2%/%input_vect )
  expect_equal( field(int_div_c_vect_neg,"vctr"), -1%/%input_vect  )
  expect_equal( field(int_div_1_c_vect,  "vctr"), input_vect%/%1   )
  expect_equal( field(int_div_2_c_vect,  "vctr"), input_vect%/%2 )
  expect_equal( field(int_div_neg_c_vect,"vctr"), input_vect%/%-1  )
...
test_that("NOT(!) works with numeric and preserves styling", {
  ...
  expect_equal( field(NOT_c_vect,  "vctr"), !input_vect   )
...
test_that("AND(&) works with numeric and preserves styling", {
  ...
  expect_equal( field(AND_c_vect_1,  "vctr"), 1%/%input_vect   )
  expect_equal( field(AND_c_vect_2,  "vctr"), 2%/%input_vect )
  expect_equal( field(AND_c_vect_neg,"vctr"), -1%/%input_vect  )
  expect_equal( field(AND_1_c_vect,  "vctr"), input_vect%/%1   )
  expect_equal( field(AND_2_c_vect,  "vctr"), input_vect%/%2 )
  expect_equal( field(AND_neg_c_vect,"vctr"), input_vect%/%-1  )
...
test_that("OR(|) works with numeric and preserves styling", {
  ...
  expect_equal( field(OR_c_vect_1,  "vctr"), 1|input_vect   )
  expect_equal( field(OR_c_vect_2,  "vctr"), 2|input_vect )
  expect_equal( field(OR_c_vect_neg,"vctr"), -1|input_vect  )
  expect_equal( field(OR_1_c_vect,  "vctr"), input_vect|1   )
  expect_equal( field(OR_2_c_vect,  "vctr"), input_vect|2 )
  expect_equal( field(OR_neg_c_vect,"vctr"), input_vect|-1  )

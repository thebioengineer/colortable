...
color_key_console <- tribble(
  ...
  "blue3","20","#0000d7",c(red = 0, green = 0, blue = 215),
  "blue1","21","#0000ff",c(red = 0, green = 0, blue = 255),
  "darkgreen","22","#005f00",c(red = 0, green = 95, blue = 0),
  "deepskyblue4","23","#005f5f",c(red = 0, green = 95, blue = 95),
  "deepskyblue4","24","#005f87",c(red = 0, green = 95, blue = 135),
  "deepskyblue4","25","#005faf",c(red = 0, green = 95, blue = 175),
  ...
  "springgreen4","29","#00875f",c(red = 0, green = 135, blue = 95),
  "turquoise4","30","#008787",c(red = 0, green = 135, blue = 135),
  "deepskyblue3","31","#0087af",c(red = 0, green = 135, blue = 175),
  ...
  "springgreen3","35","#00af5f",c(red = 0, green = 175, blue = 95),
  ...
  "green3","40","#00d700",c(red = 0, green = 215, blue = 0),
  "springgreen3","41","#00d75f",c(red = 0, green = 215, blue = 95),
  "springgreen2","42","#00d787",c(red = 0, green = 215, blue = 135),
  ...
  "deeppink4","53","#5f005f",c(red = 95, green = 0, blue = 95),
  "purple4","54","#5f0087",c(red = 95, green = 0, blue = 135),
  "purple4","55","#5f00af",c(red = 95, green = 0, blue = 175),
  "purple3","56","#5f00d7",c(red = 95, green = 0, blue = 215),
  ...
  "mediumpurple4","60","#5f5f87",c(red = 95, green = 95, blue = 135),
  "slateblue3","61","#5f5faf",c(red = 95, green = 95, blue = 175),
  "slateblue3","62","#5f5fd7",c(red = 95, green = 95, blue = 215),
  "royalblue1","63","#5f5fff",c(red = 95, green = 95, blue = 255),
  "chartreuse4","64","#5f8700",c(red = 95, green = 135, blue = 0),
  "darkseagreen4","65","#5f875f",c(red = 95, green = 135, blue = 95),
  ...
  "chartreuse3","70","#5faf00",c(red = 95, green = 175, blue = 0),
  "darkseagreen4","71","#5faf5f",c(red = 95, green = 175, blue = 95),
  "cadetblue","72","#5faf87",c(red = 95, green = 175, blue = 135),
  "cadetblue","73","#5fafaf",c(red = 95, green = 175, blue = 175),
  "skyblue3","74","#5fafd7",c(red = 95, green = 175, blue = 215),
  "steelblue1","75","#5fafff",c(red = 95, green = 175, blue = 255),
  "chartreuse3","76","#5fd700",c(red = 95, green = 215, blue = 0),
  "palegreen3","77","#5fd75f",c(red = 95, green = 215, blue = 95),
  "seagreen3","78","#5fd787",c(red = 95, green = 215, blue = 135),
  ...
  "chartreuse2","82","#5fff00",c(red = 95, green = 255, blue = 0),
  "seagreen2","83","#5fff5f",c(red = 95, green = 255, blue = 95),
  "seagreen1","84","#5fff87",c(red = 95, green = 255, blue = 135),
  "seagreen1","85","#5fffaf",c(red = 95, green = 255, blue = 175),
  "aquamarine1","86","#5fffd7",c(red = 95, green = 255, blue = 215),
  "darkslategray2","87","#5fffff",c(red = 95, green = 255, blue = 255),
  "darkred","88","#870000",c(red = 135, green = 0, blue = 0),
  "deeppink4","89","#87005f",c(red = 135, green = 0, blue = 95),
  "darkmagenta","90","#870087",c(red = 135, green = 0, blue = 135),
  "darkmagenta","91","#8700af",c(red = 135, green = 0, blue = 175),
  "darkviolet","92","#8700d7",c(red = 135, green = 0, blue = 215),
  "purple","93","#8700ff",c(red = 135, green = 0, blue = 255),
  "orange4","94","#875f00",c(red = 135, green = 95, blue = 0),
  "lightpink4","95","#875f5f",c(red = 135, green = 95, blue = 95),
  "plum4","96","#875f87",c(red = 135, green = 95, blue = 135),
  "mediumpurple3","97","#875faf",c(red = 135, green = 95, blue = 175),
  "mediumpurple3","98","#875fd7",c(red = 135, green = 95, blue = 215),
  "slateblue1","99","#875fff",c(red = 135, green = 95, blue = 255),
  "yellow4","100","#878700",c(red = 135, green = 135, blue = 0),
  ...
  "yellow4","106","#87af00",c(red = 135, green = 175, blue = 0),
  "darkolivegreen3","107","#87af5f",c(red = 135, green = 175, blue = 95),
  "darkseagreen","108","#87af87",c(red = 135, green = 175, blue = 135),
  "lightskyblue3","109","#87afaf",c(red = 135, green = 175, blue = 175),
  "lightskyblue3","110","#87afd7",c(red = 135, green = 175, blue = 215),
  "skyblue2","111","#87afff",c(red = 135, green = 175, blue = 255),
  "chartreuse2","112","#87d700",c(red = 135, green = 215, blue = 0),
  "darkolivegreen3","113","#87d75f",c(red = 135, green = 215, blue = 95),
  "palegreen3","114","#87d787",c(red = 135, green = 215, blue = 135),
  "darkseagreen3","115","#87d7af",c(red = 135, green = 215, blue = 175),
  ...
  "lightgreen","119","#87ff5f",c(red = 135, green = 255, blue = 95),
  "lightgreen","120","#87ff87",c(red = 135, green = 255, blue = 135),
  "palegreen1","121","#87ffaf",c(red = 135, green = 255, blue = 175),
  ...
  "yellow3","148","#afd700",c(red = 175, green = 215, blue = 0),
  "darkolivegreen3","149","#afd75f",c(red = 175, green = 215, blue = 95),
  "darkseagreen3","150","#afd787",c(red = 175, green = 215, blue = 135),
  "darkseagreen2","151","#afd7af",c(red = 175, green = 215, blue = 175),
  ...
  "darkolivegreen2","155","#afff5f",c(red = 175, green = 255, blue = 95),
  "palegreen1","156","#afff87",c(red = 175, green = 255, blue = 135),
  "darkseagreen2","157","#afffaf",c(red = 175, green = 255, blue = 175),
  "darkseagreen1","158","#afffd7",c(red = 175, green = 255, blue = 215),
  "paleturquoise1","159","#afffff",c(red = 175, green = 255, blue = 255),
  "red3","160","#d70000",c(red = 215, green = 0, blue = 0),
  "deeppink3","161","#d7005f",c(red = 215, green = 0, blue = 95),
  "deeppink3","162","#d70087",c(red = 215, green = 0, blue = 135),
  "magenta3","163","#d700af",c(red = 215, green = 0, blue = 175),
  "magenta3","164","#d700d7",c(red = 215, green = 0, blue = 215),
  "magenta2","165","#d700ff",c(red = 215, green = 0, blue = 255),
  "darkorange3","166","#d75f00",c(red = 215, green = 95, blue = 0),
  "indianred","167","#d75f5f",c(red = 215, green = 95, blue = 95),
  ...
  "mediumorchid1","171","#d75fff",c(red = 215, green = 95, blue = 255),
  "orange3","172","#d78700",c(red = 215, green = 135, blue = 0),
  ...
  "gold3","178","#d7af00",c(red = 215, green = 175, blue = 0),
  "lightgoldenrod3","179","#d7af5f",c(red = 215, green = 175, blue = 95),
  ...
  "lightgoldenrod2","186","#d7d787",c(red = 215, green = 215, blue = 135),
  ...
  "darkolivegreen1","191","#d7ff5f",c(red = 215, green = 255, blue = 95),
  ...
  "deeppink2","197","#ff005f",c(red = 255, green = 0, blue = 95),
  "deeppink1","198","#ff0087",c(red = 255, green = 0, blue = 135),
  ...
  "indianred1","203","#ff5f5f",c(red = 255, green = 95, blue = 95),
  "indianred1","204","#ff5f87",c(red = 255, green = 95, blue = 135),
  "hotpink","205","#ff5faf",c(red = 255, green = 95, blue = 175),
  ...
  "lightgoldenrod2","221","#ffd75f",c(red = 255, green = 215, blue = 95),
